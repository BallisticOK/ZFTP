...
dotnet publish "$ROOT/src/ZFTP.Mac/ZFTP.Mac.csproj" -c Release -r "$RID" --self-contained true -o "$PUBLISH"
...
<dict>
  ...
  <key>CFBundleVersion</key><string>2.7.9</string>
  <key>CFBundleShortVersionString</key><string>2.7.9</string>
