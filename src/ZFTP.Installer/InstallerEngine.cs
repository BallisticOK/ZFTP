...
{
    public static string Version { get; } = typeof(InstallerEngine).Assembly.GetName().Version?.ToString(3) ?? "2.7.4";
    ...
    {
        var installPath = GetRegisteredInstallPath() ?? DefaultInstallPath;
